...
public:
	...
	{
		return TEXT("scene.world.wall.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.tower.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.staircase.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.arch.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.pyramid.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.maze.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.castle.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.town.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.world.house.create");
	}
