// Foliage / Instanced Static Mesh tools for UE_AI_integration
...
public:
	...
	{
		return TEXT("scene.foliage.scatter");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.foliage.type.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.foliage.clear");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.foliage.info");
	}
