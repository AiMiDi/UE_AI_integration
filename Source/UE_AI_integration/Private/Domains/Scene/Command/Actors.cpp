			...
			if (MeshActor)
			{
				...
				if (Params->TryGetStringField(TEXT("static_mesh"), MeshPath))
				{
					...
					if (Mesh)
						...
						UE_LOG(LogTemp, Warning, TEXT("[UE_AI_integration] Static mesh not found: %s"), *MeshPath);
				}
			}
			NewActor = MeshActor;
		}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.actor.delete");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.actor.transform.set");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.actor.blueprint.spawn");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.actor.properties.get");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("scene.actor.property.set");
	}
