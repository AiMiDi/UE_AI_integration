// Sequencer / Cinematics tools for UE_AI_integration
...
public:
	...
	{
		return TEXT("production.sequence.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.actor.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.transform_keyframe.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.camera_cut.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.length.set");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.video.render");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("production.sequence.play");
	}
