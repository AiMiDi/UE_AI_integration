...
public:
	...
	{
		return TEXT("blueprint.graph.snapshot");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.graph.diff");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.graph.restore");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.pin.disconnected.find");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.graph.rebuild_impact.analyze");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_SnapshotGraph>());
		Registry.Register(MakeShared<FTool_DiffGraph>());
		Registry.Register(MakeShared<FTool_RestoreGraph>());
		Registry.Register(MakeShared<FTool_FindDisconnectedPins>());
		Registry.Register(MakeShared<FTool_AnalyzeRebuildImpact>());
	}
}
