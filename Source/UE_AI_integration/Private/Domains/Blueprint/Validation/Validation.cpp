...
public:
	...
	{
		return TEXT("blueprint.asset.validate");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.asset.validate_all");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_ValidateBlueprint>());
		Registry.Register(MakeShared<FTool_ValidateAllBlueprints>());
	}
}
