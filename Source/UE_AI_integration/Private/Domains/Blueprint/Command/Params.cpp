...
public:
	...
	{
		return TEXT("blueprint.function.parameter.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.function.parameter.remove");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.function.parameter.type.set");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_AddFunctionParameter>());
		Registry.Register(MakeShared<FTool_RemoveFunctionParameter>());
		Registry.Register(MakeShared<FTool_ChangeFunctionParameterType>());
	}
}
