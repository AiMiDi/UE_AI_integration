...
public:
	...
	{
		return TEXT("blueprint.dispatcher.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.dispatcher.list");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_AddEventDispatcher>());
		Registry.Register(MakeShared<FTool_ListEventDispatchers>());
	}
}
