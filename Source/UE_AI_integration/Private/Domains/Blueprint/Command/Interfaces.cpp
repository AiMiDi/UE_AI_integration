...
public:
	...
	{
		return TEXT("blueprint.interface.list");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.interface.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.interface.remove");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_ListInterfaces>());
		Registry.Register(MakeShared<FTool_AddInterface>());
		Registry.Register(MakeShared<FTool_RemoveInterface>());
	}
}
