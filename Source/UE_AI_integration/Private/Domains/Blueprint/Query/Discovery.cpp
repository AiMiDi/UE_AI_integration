...
public:
	...
	{
		return TEXT("blueprint.class.list");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.function.list");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.property.list");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.pin.info");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("blueprint.pin.compatibility.check");
	}
...
namespace UEAIIntegrationTools
{
	...
	{
		Registry.Register(MakeShared<FTool_ListClasses>());
		Registry.Register(MakeShared<FTool_ListFunctions>());
		Registry.Register(MakeShared<FTool_ListProperties>());
		Registry.Register(MakeShared<FTool_GetPinInfo>());
		Registry.Register(MakeShared<FTool_CheckPinCompatibility>());
	}
}
