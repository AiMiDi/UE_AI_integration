// Data Table tools for UE_AI_integration
...
public:
	...
	{
		return TEXT("content.data_table.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("content.data_table.row.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("content.data_table.row.list");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("content.data_table.row.remove");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("content.data_table.csv.import");
	}
