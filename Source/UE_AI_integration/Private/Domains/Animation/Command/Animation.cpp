...
public:
	...
	{
		return TEXT("animation.blueprint.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.state.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.state.remove");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.transition.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.transition.rule.set");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.node.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.state_machine.add");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.state.animation.set");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.blend_space.create");
	}
...
public:
	FString GetCapabilityId() const override
	{
		return TEXT("animation.blend_space.samples.set");
	}
...
namespace UEAIIntegrationTools
{
	void RegisterAnimationTools(FMCPToolRegistry& Registry)
	{
		...
		Registry.Register(MakeShared<FTool_AddAnimState>());
		Registry.Register(MakeShared<FTool_RemoveAnimState>());
		Registry.Register(MakeShared<FTool_AddAnimTransition>());
		Registry.Register(MakeShared<FTool_SetTransitionRule>());
		Registry.Register(MakeShared<FTool_AddAnimNode>());
		Registry.Register(MakeShared<FTool_AddStateMachine>());
